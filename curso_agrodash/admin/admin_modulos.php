        ...
        <div class="admin-content">
            ...
            <div class="curso-info">
                ...
                <div style="display: flex; gap: 15px; margin-top: 15px; flex-wrap: wrap;">
                    <a href="/curso_agrodash/admincursos" class="btn btn-secondary">
                        <i class="fas fa-arrow-left"></i> Voltar aos Cursos
                    </a>
                    <a href="/curso_agrodash/admincursosedit?id=<?= $curso['id'] ?>" class="btn btn-warning">
                    ...
                    <a href="/curso_agrodash/adminprovafinal?curso_id=<?= $curso_id ?>" class="btn btn-info">
                        ...
                        <div class="modulo-item">
                            <div class="modulo-header">
                                ...
                                <div class="modulo-acoes">
                                    <a href="/curso_agrodash/adminconteudos?modulo_id=<?= $modulo['id'] ?>" class="btn btn-primary">
                ...
                <div class="prova-final-section">
                    ...
                    <?php if ($prova_final): ?>
                        ...
                        <div style="display: flex; gap: 15px; flex-wrap: wrap;">
                            ...
                            <a href="/curso_agrodash/adminprovafinal?curso_id=<?= $curso_id ?>&acao=visualizar" class="btn btn-info">
