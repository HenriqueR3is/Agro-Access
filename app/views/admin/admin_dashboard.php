...
<head>
    ...
    <title>Dashboard Administrativo - Agro-Access Export</title>
...
<h2>Dashboard Geral - Sistema de Exportação Agro-Access</h2>
...
<div class="card">
    ...
    <div id="exportacao" class="tab-content">
        ...
        <div style="background: white; padding: 20px; border-radius: 8px; margin-top: 20px;">
            ...
            <p><strong>Organização dos Arquivos:</strong> Os dados são organizados por cluster (NORTE, CENTRO, SUL) e operação, seguindo o padrão do sistema Agro-Access.</p>
