    ...
    <div class="main-content">
        <div class="sidebar">
            <div class="sidebar-nav">
                ...
                <a href="fazendas" class="<?php echo basename($_SERVER['PHP_SELF']) == 'admin_farms.php' ? 'active' : ''; ?>">Fazendas e Unidades</a>                                <a href="metas" class="<?php echo basename($_SERVER['PHP_SELF']) == 'admin_metas.php' ? 'active' : ''; ?>">Controle Metas</a>
