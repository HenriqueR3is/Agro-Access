    ...
    <div class="main-content">
        <div class="sidebar">
            <div class="sidebar-nav">
                ...
                <a href="user_dashboard" class="<?php echo basename($_SERVER['PHP_SELF']) == 'user_dashboard.php' ? 'active' : ''; ?>">User - Dash</a>
                ...
                <a href="dashboard" class="<?php echo basename($_SERVER['PHP_SELF']) == 'dashboard.php' ? 'active' : ''; ?>">CIA - Dash</a>
            </div>
        </div>
        <div class="container">